...
class Linter {
    ...
    getContext(options) {
        const rule = new defaultRules['context-builder']({
        ...
        nodeTypes.forEach((nodeType) => {
            Scanner.prototype[nodeType] = function (node) {
                if (nodeHandler.visitor[nodeType]) {
                    nodeHandler.visitor[nodeType].call(nodeHandler.rule, node, this);
                }
        ...
        try {
            ...
            //Ignore errors when context-extracting
        }
